...
public:
    int arrayPairSum(vector<int>& nums) {
        ...
        // otherwise the larger number is sacrificed. It's very similar to the bucket theory: a bucket can only fill with 
        // the volume of water the shortest plank allows.
